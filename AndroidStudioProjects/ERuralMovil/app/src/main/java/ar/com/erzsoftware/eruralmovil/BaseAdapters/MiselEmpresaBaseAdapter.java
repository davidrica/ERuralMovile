...
public abstract class MiselEmpresaBaseAdapter extends BaseAdapter {
    ...
    public MiselEmpresaBaseAdapter(Context contexto, int R_layout_IdView, ArrayList<?> entradas) {
        super();
