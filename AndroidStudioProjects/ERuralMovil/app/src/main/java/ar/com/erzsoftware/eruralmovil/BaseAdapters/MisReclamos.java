...
/**
 * Created by Administrador on 11/10/2017.
 */

public abstract class MisReclamos extends BaseAdapter {
    ...
    public MisReclamos(Context contexto, int R_layout_IdView, ArrayList<?> entradas) {
        super();
